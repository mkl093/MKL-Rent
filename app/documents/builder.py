...
LABELS = {
    "ru": {
        ...
        "weight": "Вес",
        "vol_loose": "Об. б/у",
        "dimensions": "Габариты кейса/ед. (ДхШхВ), мм",
        "volume": "Об. всего",
        "comment": "Комментарий",
    ...
    "en": {
        ...
        "weight": "Weight",
        "vol_loose": "Vol. loose",
        "dimensions": "Case/unit dims (LxWxH), mm",
        "volume": "Vol. total",
        "comment": "Comment",
    ...
    "de": {
        ...
        "packages_unit": "Kolli",
        "eq_weight": "Ger.-Gew.",
        "pack_weight": "Verp.-Gew.",
        "eq_short": "Ger.",
        "pack_short": "Verp.",
        "weight": "Gewicht",
        "vol_loose": "Vol. lose",
        "dimensions": "Kolli-/Gerätemaße (LxBxH), mm",
        "volume": "Vol. ges.",
        "comment": "Kommentar",
